...
func init() {
	...
	SupportedAttacks.RegisterAttack("pollardsrho", false, true, 300, pollardsrho.Attack)
	SupportedAttacks.RegisterAttack("pollardrhobrent", false, true, 300, pollardrhobrent.Attack)
